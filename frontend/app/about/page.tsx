...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about our mission, values, and the team behind ModernWeb.',
};
    ...
    <div className="py-24">
      <div className="container">
        ...
        <div className="text-center mb-16">
          <Badge variant="secondary" className="mb-4">About ModernWeb</Badge>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Founded in 2019, ModernWeb started as a small team of developers who believed 
              that web development could be more efficient, more beautiful, and more impactful. 
              We were frustrated with the complex, slow-moving tools available at the time.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Today, we've grown into a full-service web development agency that has helped 
              hundreds of businesses transform their digital presence. Our commitment to 
              innovation and quality has never wavered.
            </p>
          </div>
        ...
        <div className="text-center bg-muted/50 rounded-lg p-12">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            ...
            but also drive measurable results. We believe that great web experiences should be 
