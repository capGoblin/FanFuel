...
export const metadata: Metadata = {
  title: 'Services',
  description: 'Comprehensive web development services including modern web applications, mobile apps, and UI/UX design.',
};
...
const services = [
  ...
  },
  {
    ...
    features: ['React Native', 'Native iOS & Android', 'Cross-platform', 'App Store Deployment'],
  ...
  },
  {
    ...
    features: ['Google Analytics', 'SEO Optimization', 'Performance Monitoring', 'Reporting'],
