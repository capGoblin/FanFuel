        ...
        <Card className="bg-gray-900/50 border-gray-700/50 backdrop-blur-sm overflow-hidden group hover:border-purple-500/50 transition-all duration-300">
          <div className="relative">
            ...
            {nft.isListed && (
              <Badge
                variant="secondary"
                className="absolute top-3 right-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0 shadow-lg"
              >
                Listed
              </Badge>
            )}
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="flex space-x-2">
                ...
                <Button
                  ...
                  className={
                    nft.isListed
                      ? "bg-gradient-to-r from-red-500/80 to-orange-500/80 backdrop-blur-sm border-red-300/30 text-white hover:from-red-500 hover:to-orange-500"
                      : "bg-gradient-to-r from-purple-500/80 to-pink-500/80 backdrop-blur-sm border-purple-300/30 text-white hover:from-purple-500 hover:to-pink-500"
                  }
                >
                  <DollarSign className="h-4 w-4 mr-1" />
                  {nft.isListed ? "Remove" : "List"}
                </Button>
                <Button
                  size="sm"
                  variant="secondary"
