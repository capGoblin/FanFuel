...
const features = [
  {
    ...
    description:
      "Built with Next.js 13+, TypeScript, and the latest web technologies for optimal performance.",
  },
  {
    icon: Zap,
    title: "Lightning Fast",
    description:
      "Optimized for speed with server-side rendering, static generation, and intelligent caching.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    title: "Global Scale",
    description:
      "Deploy worldwide with CDN support and automatic optimization for any region.",
  },
  {
    icon: Users,
    title: "Team Collaboration",
    description:
      "Built for teams with version control, staging environments, and seamless workflows.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            need to create exceptional web experiences.
          </p>
        </div>
