          ...
          <div className={`space-y-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Create stunning, performant applications with Next.js, TypeScript, and cutting-edge design systems. 
            ...
            <div className="flex items-center space-x-8 text-sm text-muted-foreground">
              ...
              <div>
                <span className="font-semibold text-foreground">500+</span> Projects Delivered
              </div>
              <div>
